	  ...
	  $(function (){
	  		$("#propsName1").change(function(){
				...
				if(propsName1 != null && propsName1 != ''){
					$.ajax({
						url:'<%=request.getContextPath()%>/background/testData/findByName.html',
   ...
   <div class="box">
     <div class="box_border">
       <div class="box_top" ><b class="pl15" >系统管理——>修改信息</b></div>
		...
		<form action="<%=request.getContextPath()%>/background/testData/updateById.html" method="post" name="userForm" id="userForm">
