...
$(function(){
	$(".loading").showLoading(); 
	var url = "<%=request.getContextPath()%>/background/systemServerInfo/warnInfo.html";
	$.ajax({
		type : 'POST',
		url : url,
		dataType : 'json',
		...
		fchart("CPU使用情况","%",  (100-data.cpuUsage), "已经使用", data.cpuUsage, "cpu", "cpuchart");
...
function modifySer(key){
	$.ajax({
        async: false,
        url: "<%=request.getContextPath()%>/background/systemServerInfo/modifySer.html",
