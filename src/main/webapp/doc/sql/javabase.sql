...
insert into sys_sources values ('25', '日志管理', '1010', 'sys_manager_logs', '0', 'sys_manager_logs', '25', '日志管理',1,0);
insert into sys_sources values ('26', '操作日志', '25', 'sys_logs_find', '1', '/background/systemLogs/find.html', '26', '操作日志',1,0);
insert into sys_sources values ('27', '登录日志', '25', 'login_logs_list', '1', '/background/systemLogs/logins.html', '27', '登录日志',1,0);
