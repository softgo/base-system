...
import com.javabase.system.entity.ServerStatus.CpuInfoVo;
import com.javabase.system.entity.ServerStatus.DiskInfoVo;
import com.javabase.system.web.SystemServerInfoController;
...
public class CommonUtils {
	...
	public static List<String> removeSameItem(List<String> list) {
		...
		for (String t : list) {
			if (!StringDefaultValue.isEmpty(t) && !difList.contains(t)) {
				difList.add(t.trim());
			}
		}
		return difList;
	...
	private static void resetClasspath() {
		...
		String classpath =SystemServerInfoController.class.getResource("/").getPath();
