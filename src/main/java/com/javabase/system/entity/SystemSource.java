...
public class SystemSource extends BaseBean {
	...
	private Set<SystemSource> childs = new HashSet<SystemSource>(0);
	
	public SystemSource () {
		super();
	}
	
	public SystemSource (String sourceName ,int parentId ,String sourceKey ,String sourceType ,String sourceUrl ,int sourceLevel ,String description ,int sourceStatus ,int isIframe ) {
		super();
	...
	public SystemSource (String sourceName ,int parentId ,String sourceKey ,String sourceType ,String sourceUrl ,int sourceLevel ,String description ,int sourceStatus ,int isIframe,
			Set<SystemRole> roles,Set<SystemSource> childs) {
		super();
		 this.sourceName = sourceName;
		 this.parentId = parentId;
		 this.sourceKey = sourceKey;
